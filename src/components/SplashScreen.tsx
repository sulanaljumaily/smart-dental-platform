...
export const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* المحتوى المركزي: الشعار الأنيق المتطابق مع الصورة والنصوص */}
      <div className="splash-center-content">
        {/* أيقونة المنصة بتصميم السكويركل النقي المتطابق مع الصورة المرفقة */}
        <div className="splash-app-icon-frame">
