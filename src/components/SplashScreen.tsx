...
export const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* المحتوى المركزي: الشعار ذو الإطار المزدوج والنصوص */}
      <div className="splash-center-content">
        {/* مسرح الأيقونة المزدوجة مع تأثيرات الحركة والانعكاس والهالة */}
        <div className="splash-icon-stage">
          {/* هالة النبض المتوهجة التفاعلية */}
          <div className="splash-icon-aura" aria-hidden="true"></div>

          {/* الإطار الخارجي المجسم مع تأثير الانعكاس والنبض */}
          <div className="splash-outer-squircle">
            {/* لمعة الضوء المتحركة التي تمر فوق الشعار */}
            <div className="splash-shimmer-sweep" aria-hidden="true"></div>

            {/* الإطار الداخلي الأنيق المحتضن للرمز الأبيض */}
            <div className="splash-inner-squircle">
              <svg viewBox="0 0 128 128" className="splash-symbol-svg" fill="none">
                <path
