              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-center px-6 sm:px-10 md:px-16 text-white z-20">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-white/10 backdrop-blur-md rounded-full w-fit mb-4 border border-white/10">
                    ...
                    <span className="text-xs sm:text-sm font-medium text-orange-100">شريك النجاح الأول للقطاع الطبي</span>
                  </div>
                  ...
                  <div className="flex gap-4">
                    <Link to="/register?type=supplier">
                      <Button className="bg-white text-orange-900 hover:bg-gray-100 px-6 py-3 md:px-7 md:py-3.5 rounded-xl md:rounded-2xl text-base md:text-lg font-bold shadow-lg shadow-orange-900/20 transition-all hover:-translate-y-1">
                        انضم كمورد الآن
                      </Button>
                    </Link>
                  </div>
